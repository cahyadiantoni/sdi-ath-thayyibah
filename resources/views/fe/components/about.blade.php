  ...
  <div class="row gy-4 align-items-center">
    ...
    <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
        ...
        <table>
            ...
            <tr>
                <td>Email : </td>
                <td>sdi.attoyyibah@gmail.com</td>
            </tr>
            <tr>
        ...
        <h3>Misi Sekolah</h3>
        <ul>
            <li><i class="bi bi-check-circle"></i> <span>Membangun sinergi tiga subsistem pendidikan, yakni : Keluarga, Sekolah, dan Masyarakat.</span></li>
            <li><i class="bi bi-check-circle"></i> <span>Meningkatkan dan mengembangkan sarana dan prasarana pendidikan.</span></li>
